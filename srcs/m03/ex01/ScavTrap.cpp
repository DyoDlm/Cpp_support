...
int	ScavTrap::getAPdamage() const
{
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name)
{
	...
	std::cout << ROSE << "Into ScavTrap Default Constructor" << RESET << std::endl;
}

ScavTrap::ScavTrap(const ScavTrap &obj) : ClapTrap(obj)
{
	std::cout  << ROSE << "Into ScavTrap Copy Constructor" << RESET <<std::endl;
...
void	ScavTrap::attack(const std::string &target)
{
	...
	{
		std::cout << ROSE << "ScavTrap " << RESET << _name << " attacks : " << target
