...
{
	std::cout << YELLOW << "In ClapTrap Default Constructor creating : "
	<< name << RESET << std::endl;
	this->_name = name;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << YELLOW << "In ClapTrap Default Destructor" << RESET << std::endl;
}
...
{
	std::cout << YELLOW << "ClapTrap " << RESET << name << " can't do " << "'"
...
{
	std::cout << YELLOW << "ClapTrap " << RESET << this->_name << " take " << amount
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (_EnergyPoints && _HitPoints)
	{
		std::cout << YELLOW << "ClapTrap " << RESET << this->_name
		<< " is repaired by :" << amount << std::endl;
		_HitPoints += amount;
		_EnergyPoints--;
	}
	else
